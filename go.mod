...
require (
	...
	github.com/alibabacloud-go/alidns-20150109/v5 v5.4.0
...
replace github.com/infobloxopen/infoblox-go-client/v2 => github.com/MartinWeindel/infoblox-go-client/v2 v2.0.0-20221111083133-0632f4c02428
