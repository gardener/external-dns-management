...
type DNSOwnerInformer interface {
	...
	Lister() dnsv1alpha1.DNSOwnerLister
}
...
func (f *dNSOwnerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisdnsv1alpha1.DNSOwner{}, f.defaultInformer)
}

func (f *dNSOwnerInformer) Lister() dnsv1alpha1.DNSOwnerLister {
	return dnsv1alpha1.NewDNSOwnerLister(f.Informer().GetIndexer())
}
