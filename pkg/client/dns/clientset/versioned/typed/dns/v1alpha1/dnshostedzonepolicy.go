...
func (c *dNSHostedZonePolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DNSHostedZonePolicy, err error) {
	result = &v1alpha1.DNSHostedZonePolicy{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dnshostedzonepolicies").
		Name(name).
...
func (c *dNSHostedZonePolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DNSHostedZonePolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DNSHostedZonePolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dnshostedzonepolicies").
...
func (c *dNSHostedZonePolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dNSHostedZonePolicies) Create(ctx context.Context, dNSHostedZonePolicy *v1alpha1.DNSHostedZonePolicy, opts v1.CreateOptions) (result *v1alpha1.DNSHostedZonePolicy, err error) {
	result = &v1alpha1.DNSHostedZonePolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dnshostedzonepolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dNSHostedZonePolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *dNSHostedZonePolicies) Update(ctx context.Context, dNSHostedZonePolicy *v1alpha1.DNSHostedZonePolicy, opts v1.UpdateOptions) (result *v1alpha1.DNSHostedZonePolicy, err error) {
	result = &v1alpha1.DNSHostedZonePolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dnshostedzonepolicies").
		Name(dNSHostedZonePolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dNSHostedZonePolicy).
		Do(ctx).
		Into(result)
...
func (c *dNSHostedZonePolicies) UpdateStatus(ctx context.Context, dNSHostedZonePolicy *v1alpha1.DNSHostedZonePolicy, opts v1.UpdateOptions) (result *v1alpha1.DNSHostedZonePolicy, err error) {
	result = &v1alpha1.DNSHostedZonePolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dnshostedzonepolicies").
...
func (c *dNSHostedZonePolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dNSHostedZonePolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dNSHostedZonePolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DNSHostedZonePolicy, err error) {
	result = &v1alpha1.DNSHostedZonePolicy{}
