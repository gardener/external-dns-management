...
// DNSLocksGetter has a method to return a DNSLockInterface.
...
// dNSLocks implements DNSLockInterface
type dNSLocks struct {
	client rest.Interface
	ns     string
}

// newDNSLocks returns a DNSLocks
func newDNSLocks(c *DnsV1alpha1Client, namespace string) *dNSLocks {
	return &dNSLocks{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *dNSLocks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DNSLock, err error) {
	result = &v1alpha1.DNSLock{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dnslocks").
		Name(name).
...
func (c *dNSLocks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DNSLockList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DNSLockList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dnslocks").
...
func (c *dNSLocks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dNSLocks) Create(ctx context.Context, dNSLock *v1alpha1.DNSLock, opts v1.CreateOptions) (result *v1alpha1.DNSLock, err error) {
	result = &v1alpha1.DNSLock{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dnslocks").
...
func (c *dNSLocks) Update(ctx context.Context, dNSLock *v1alpha1.DNSLock, opts v1.UpdateOptions) (result *v1alpha1.DNSLock, err error) {
	result = &v1alpha1.DNSLock{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dnslocks").
...
func (c *dNSLocks) UpdateStatus(ctx context.Context, dNSLock *v1alpha1.DNSLock, opts v1.UpdateOptions) (result *v1alpha1.DNSLock, err error) {
	result = &v1alpha1.DNSLock{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dnslocks").
...
func (c *dNSLocks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dNSLocks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dNSLocks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DNSLock, err error) {
	result = &v1alpha1.DNSLock{}
