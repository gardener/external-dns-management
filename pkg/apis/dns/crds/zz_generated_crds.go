          ...
          status:
            properties:
              cnameLookupInterval:
                ...
                type: integer
              dnsName:
                description: effective full qualified domain name
                type: string
              lastUpdateTime:
              ...
              observedGeneration:
                ...
                type: integer
              pending:
                description: Pending contains the pending spec
                properties:
                  dnsName:
                    description: effective full qualified domain name
                    type: string
                  pendingGeneration:
                    description: generation to be applied next
                    format: int64
                    type: integer
                  resolveTargetsToAddresses:
                    description: effective resolveTargetsToAddresses from spec
                    type: boolean
                  routingPolicy:
                    description: optional routing policy
                    properties:
                      parameters:
                        ...
                        type: object
                      setIdentifier:
                        description: SetIdentifier is the identifier of the record
                          set
                        type: string
                      type:
                        description: Policy is the policy type. Allowed values are
                          provider dependent, e.g. ` + "`" + `weighted` + "`" + `
                        type: string
                    required:
                    - parameters
                    - setIdentifier
                    ...
                    type: object
                  targets:
                    description: effective target records (A, AAAA, or CNAME records)
                    items:
                      type: string
                    type: array
                  text:
                    description: effective text records (TXT records)
                    items:
                      type: string
                    type: array
                  ttl:
                    description: effective time to live for records in external DNS
                      system
                    format: int64
                    type: integer
                required:
              ...
              text:
                ...
                type: array
              ttl:
                description: effective time to live for records in external DNS system
                format: int64
                type: integer
              zone:
