...
// ProviderType is the type identifier for the Azure DNS provider.
const ProviderType = "azure-dns"

// RegisterTo registers the Azure DNS handler to the given registry.
...
// newAdapter creates a new DNSHandlerAdapter for the Azure DNS provider.
