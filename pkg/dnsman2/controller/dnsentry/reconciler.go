...
func (r *Reconciler) updateStatusError(ctx context.Context, entry *v1alpha1.DNSEntry, err error) error {
	return r.updateStatusFailed(ctx, entry, v1alpha1.StateError, err)
}
