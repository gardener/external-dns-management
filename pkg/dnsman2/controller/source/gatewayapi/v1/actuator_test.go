...
import (
	...
	. "github.com/gardener/external-dns-management/pkg/dnsman2/controller/source/gatewayapi/v1"
...
func doReconcile(ctx context.Context, reconciler *common.SourceReconciler[*gatewayapisv1.Gateway], gateway *gatewayapisv1.Gateway) error {
	req := reconcile.Request{NamespacedName: types.NamespacedName{Namespace: gateway.Namespace, Name: gateway.Name}}
	_, err := reconciler.Reconcile(ctx, req)
	return err
}

func getDNSEntries(ctx context.Context, c client.Client, reconciler *common.SourceReconciler[*gatewayapisv1.Gateway]) *dnsv1alpha1.DNSEntryList {
