...
const ControllerName = "istiov1alpha3-source"

// Actuator is an actuator for provided Istio v1alpha3 Gateway resources.
...
var (
	...
	Activated bool
	_         common.SourceActuator[*istionetworkingv1alpha3.Gateway] = &Actuator{}
)

// NewActuator creates a new Actuator for Istio v1alpha3 Gateway resources.
...
// ReconcileSourceObject reconciles the given Istio v1alpha3 Gateway resource.
func (a *Actuator) ReconcileSourceObject(
	ctx context.Context,
	r *common.SourceReconciler[*istionetworkingv1alpha3.Gateway],
...
// FinalizerLocalName returns the local name of the finalizer for Istio v1alpha3 Gateway resources.
...
func (a *Actuator) GetGVK() schema.GroupVersionKind {
	return istionetworkingv1alpha3.SchemeGroupVersion.WithKind("Gateway")
}

// IsRelevantSourceObject checks whether the given Istio v1alpha3 Gateway resource is relevant for processing.
func (a *Actuator) IsRelevantSourceObject(r *common.SourceReconciler[*istionetworkingv1alpha3.Gateway], gateway *istionetworkingv1alpha3.Gateway) bool {
	if gateway == nil {
		return false
	}
...
// NewSourceObject creates a new Istio v1alpha3 Gateway resource.
func (a *Actuator) NewSourceObject() *istionetworkingv1alpha3.Gateway {
...
func (a *Actuator) ShouldActivate() (bool, error) {
	...
	return apiVersion != nil && *apiVersion == istio.V1Alpha3, nil
}

// WatchRelatedResources adds watches for Istio v1alpha3 VirtualService, Ingress, and Service to the given builder that maps them to Istio v1alpha3 Gateway reconciliation requests.
...
func (a *Actuator) mapVirtualServiceToGatewayRequest(_ context.Context, obj client.Object) []reconcile.Request {
	virtualService, ok := obj.(*istionetworkingv1alpha3.VirtualService)
	if !ok {
		return nil
	}
