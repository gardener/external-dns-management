...
var _ = Describe("Actuator", func() {
	var actuator *v1alpha3actuator.Actuator

	BeforeEach(func() {
		actuator = v1alpha3actuator.NewActuator(nil)
	})

	Describe("#ControllerName", func() {
		It("should return the controller name", func() {
			Expect(actuator.ControllerName()).To(Equal("istiov1alpha3-source"))
		})
	})
	...
	Describe("#GetGVK", func() {
		It("should return the Istio v1alpha3 Gateway GVK", func() {
			gvk := actuator.GetGVK()
	...
	Describe("#NewSourceObject", func() {
		It("should return a new empty Gateway", func() {
			...
			Expect(obj).To(BeAssignableToTypeOf(&istionetworkingv1alpha3.Gateway{}))
		})
	})
	...
	Describe("#ShouldActivate", func() {
		...
		BeforeEach(func() {
			...
			actuator = v1alpha3actuator.NewActuator(dc)
		})

		It("should return true when Istio v1alpha3 Gateway and VirtualService CRDs are present", func() {
			dc.Resources = []*metav1.APIResourceList{
				{
		...
		It("should return false when v1beta1 CRDs are present (v1beta1 takes priority)", func() {
			dc.Resources = []*metav1.APIResourceList{
				{
	...
	Describe("#IsRelevantSourceObject", func() {
		var r *common.SourceReconciler[*istionetworkingv1alpha3.Gateway]

		BeforeEach(func() {
			r = &common.SourceReconciler[*istionetworkingv1alpha3.Gateway]{
				GVK:   istionetworkingv1alpha3.SchemeGroupVersion.WithKind("Gateway"),
