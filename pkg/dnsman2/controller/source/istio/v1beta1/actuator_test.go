...
import (
	...
	v1beta1actuator "github.com/gardener/external-dns-management/pkg/dnsman2/controller/source/istio/v1beta1"
	"github.com/gardener/external-dns-management/pkg/dnsman2/dns"
	"github.com/gardener/external-dns-management/pkg/dnsman2/dns/state"
)

var _ = Describe("Actuator", func() {
	var actuator *v1beta1actuator.Actuator

	BeforeEach(func() {
		actuator = v1beta1actuator.NewActuator(nil)
	})

	Describe("#ControllerName", func() {
		It("should return the controller name", func() {
			Expect(actuator.ControllerName()).To(Equal("istiov1beta1-source"))
		})
	})
	...
	Describe("#GetGVK", func() {
		It("should return the Istio v1beta1 Gateway GVK", func() {
			gvk := actuator.GetGVK()
	...
	Describe("#NewSourceObject", func() {
		It("should return a new empty Gateway", func() {
			...
			Expect(obj).To(BeAssignableToTypeOf(&istionetworkingv1beta1.Gateway{}))
		})
	})
	...
	Describe("#ShouldActivate", func() {
		...
		BeforeEach(func() {
			...
			actuator = v1beta1actuator.NewActuator(dc)
		})

		It("should return true when Istio v1beta1 Gateway and VirtualService CRDs are present", func() {
			dc.Resources = []*metav1.APIResourceList{
				{
		...
		It("should return false when v1 CRDs are present (v1 takes priority)", func() {
			dc.Resources = []*metav1.APIResourceList{
				{
	...
	Describe("#IsRelevantSourceObject", func() {
		var r *common.SourceReconciler[*istionetworkingv1beta1.Gateway]

		BeforeEach(func() {
			r = &common.SourceReconciler[*istionetworkingv1beta1.Gateway]{
				GVK:   istionetworkingv1beta1.SchemeGroupVersion.WithKind("Gateway"),
