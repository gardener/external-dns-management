...
const ControllerName = "istiov1beta1-source"

// Actuator is an actuator for provided Istio v1beta1 Gateway resources.
...
var (
	...
	Activated bool
	_         common.SourceActuator[*istionetworkingv1beta1.Gateway] = &Actuator{}
)

// NewActuator creates a new Actuator for Istio v1beta1 Gateway resources.
...
// ReconcileSourceObject reconciles the given Istio v1beta1 Gateway resource.
func (a *Actuator) ReconcileSourceObject(
	ctx context.Context,
	r *common.SourceReconciler[*istionetworkingv1beta1.Gateway],
...
// FinalizerLocalName returns the local name of the finalizer for Istio v1beta1 Gateway resources.
...
func (a *Actuator) GetGVK() schema.GroupVersionKind {
	return istionetworkingv1beta1.SchemeGroupVersion.WithKind("Gateway")
}

// IsRelevantSourceObject checks whether the given Istio v1beta1 Gateway resource is relevant for processing.
func (a *Actuator) IsRelevantSourceObject(r *common.SourceReconciler[*istionetworkingv1beta1.Gateway], gateway *istionetworkingv1beta1.Gateway) bool {
	if gateway == nil {
		return false
	}
...
// NewSourceObject creates a new Istio v1beta1 Gateway resource.
func (a *Actuator) NewSourceObject() *istionetworkingv1beta1.Gateway {
...
// OnDelete is called when an Istio v1beta1 Gateway resource is deleted.
func (a *Actuator) OnDelete(gateway *istionetworkingv1beta1.Gateway) {
	a.state.RemoveGateway(gateway)
}

// ShouldActivate checks whether the required Istio v1beta1 CRDs are present in the cluster.
func (a *Actuator) ShouldActivate() (bool, error) {
	apiVersion, err := istio.DetermineAPIVersion(a.Discovery)
	if err != nil {
		return false, err
	}
	return apiVersion != nil && *apiVersion == istio.V1Beta1, nil
}

// WatchRelatedResources adds watches for Istio v1beta1 VirtualService, Ingress, and Service to the given builder that maps them to Istio v1beta1 Gateway reconciliation requests.
