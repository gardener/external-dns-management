...
func (r *Reconciler) updateStatusError(ctx context.Context, provider *v1alpha1.DNSProvider, msg string) error {
	return r.updateStatusFailed(ctx, provider, v1alpha1.StateError, msg)
}
