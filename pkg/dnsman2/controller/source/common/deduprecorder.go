...
type RecorderWithDeduplication interface {
	...
	DedupEventf(client client.Object, eventtype, reason, messageFmt string, args ...any)
}
...
func (d *dedupRecorder) Eventf(object runtime.Object, eventtype, reason, messageFmt string, args ...any) {
...
func (d *dedupRecorder) AnnotatedEventf(object runtime.Object, annotations map[string]string, eventtype, reason, messageFmt string, args ...any) {
	obj, ok := object.(client.Object)
	if ok {
		msg := fmt.Sprintf(messageFmt, args...)
		d.eventCache.Set(client.ObjectKeyFromObject(obj), msg, ttlcache.DefaultTTL)
...
func (d *dedupRecorder) DedupEventf(object client.Object, eventtype, reason, messageFmt string, args ...any) {
	msg := fmt.Sprintf(messageFmt, args...)
