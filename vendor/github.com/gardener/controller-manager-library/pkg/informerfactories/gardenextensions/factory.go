...
import (
	...
	informers "github.com/gardener/controller-manager-library/pkg/client/gardenextensions/informers/externalversions"
	"github.com/gardener/controller-manager-library/pkg/clientsets"
	typed "github.com/gardener/controller-manager-library/pkg/clientsets/gardenextensions"
...
func SharedInformerFactory(informerfactories informerfactories.Interface) (informers.SharedInformerFactory, error) {
	...
	if !ok {
		return nil, fmt.Errorf("unable to convert factory to gardenextensions factory: %T", factory)
	}
