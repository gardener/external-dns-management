	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GardenextensionsV1alpha1().Infrastructures(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GardenextensionsV1alpha1().Infrastructures(namespace).Watch(options)
			},
		},
...
func (f *infrastructureInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&gardenextensionsv1alpha1.Infrastructure{}, f.defaultInformer)
}
